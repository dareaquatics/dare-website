document.addEventListener("DOMContentLoaded", function () {
    ...
    const minLoadingTime = 200; // Minimum loading time
    const maxLoadingTime = 900; // Maximum loading time
    const randomLoadingTime = Math.floor(Math.random() * (maxLoadingTime - minLoadingTime + 1)) + minLoadingTime;
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        showContent();
      }, 1000); // Keep animation for 1 second after loading
